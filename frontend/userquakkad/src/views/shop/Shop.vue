              ...
              <div class="single-widget search">
                ...
                <form>
                  <input
                    ...
                    v-model="search"
                  />
                  <button @click.prevent="searchProduct" type="submit">
                        ...
                        <div class="product-image">
                          ...
                          <div class="button">
                            <button
                              ...
                              class="btn"
                            >
                              <i lass="lni lni-cart"></i> Add to Cart
                            </button>
                          </div>
                        </div>
                        <div
  ...
  methods: {
    ...
    getImgUrl(image) {
      ...
      let url = require.context(
        "C:/xampp/htdocs/Quakka/frontend/dashboardadminquakkad/src/assets/img/product/",
        false,
        /\.(png|jpe?g|svg)$/
      );
