...
export default {
    ...
    methods: {
        submitPayment() {
            this.$store.dispatch("submitPayment", this.payment_details);
        },
    },
};
</script>
        ...
        <div class="col-12">
          <div class="checkout-payment-form">
            <div class="single-form form-default">
              ...
              <div class="form-input form">
                <input
                  ...
                  required
                  v-model="payment_details.cardholder_name"
                />
              </div>
            </div>
            <div class="single-form form-default">
                ...
                <div class="expiration d-flex">
                  <div class="form-input form">
                    <input
                      ...
                      placeholder="MM"
                      required
                      v-model="payment_details.expiration_month"
                    />
                  </div>
                  <div class="form-input form">
                    <input
                      ...
                      placeholder="YYYY"
                      required
                      v-model="payment_details.expiration_year"
                    />
                  </div>
                </div>
              </div>
            ...
            <div class="single-form form-default button">
              <button @click.prevent="submitPayment" class="btn">
                pay now
              </button>
            </div>
          </div>
