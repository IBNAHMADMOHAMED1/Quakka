              ...
              ">
                ...
                ">
                        ...
                        ">
                                    ...
                                    <tbody v-if="halls.length == 0 && !searchIsLoading" class="
                      text-center
                       p-5
                       w-1/2
                       ">
                            ...
                            text-gray-500">
                                            ...
                                            <td @click="view_hall(hall)" :class="`cursor-pointer ${default_ClassName}`">
                                                <LinkIcon className="w-5 h-5 text-blue-400" />
                                            </td>
                                            <td @click="edit_hall(hall)" :class="`cursor-pointer ${default_ClassName}`">
