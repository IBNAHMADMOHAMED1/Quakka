                ...
                <div class="container">
                    <div class="flex -mx-4 gap-10 ">
                        ...
                        >
                            ...
                            xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="797.5" height="834.5"
                                ...
                                <path
                                    ...
                                    transform="translate(-201.25 -32.75)" fill="#2f2e41" />
                                <circle cx="559" cy="744.5" r="43" fill="#a020f0" />
                                <circle cx="54" cy="729.5" r="43" fill="#a020f0" />
                                <circle cx="54" cy="672.5" r="31" fill="#a020f0" />
                                <circle cx="54" cy="624.5" r="22" fill="#a020f0" />
                            </svg>
