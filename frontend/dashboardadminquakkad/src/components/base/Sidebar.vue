<template>
  <div class="
    ...
    <div class="mb-4 px-4">
      ...
      <div @click="$router.push('/dashboard')" class="
          w-full
          flex
          items-center
          text-purple-700
      ...
      <div class="
        ...
        <svg class="h-6 w-6 fill-current mr-2" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
          xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 204.367 204.367"
          style="enable-background: new 0 0 204.367 204.367" xml:space="preserve">
	...
	c0-6.109,2.482-11.65,6.49-15.667c-6.952,1.818-12.097,8.153-12.097,15.667V40.671z" />
      ...
      <div @click="$router.push('/tasks')" class="
          w-full
          flex
          items-center
          text-purple-700
          ...
          cursor-pointer
        ">
        <svg class="h-6 w-6 fill-current mr-2 bi bi-list-task" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <div class="mb-4 px-4">
      ...
      <div @click="$router.push('/products')" class="
          w-full
          flex
          items-center
          text-purple-700
    ...
    <div class="mb-4 px-4">
      ...
      <div @click="$router.push('/halls')" class="
          w-full
          flex
          items-center
          text-purple-700
    ...
    <div class="mb-4 px-4">
      ...
      <div @click="$router.push('/create-blog')" class="
          w-full
          flex
          items-center
          text-purple-700
      ...
      <div @click="$router.push('/blogs')" class="
          w-full
          flex
          items-center
          text-purple-700
    ...
    <div class="mb-4 px-4">
      ...
      <div @click="$router.push('/subscribers')" class="
          w-full
          flex
          items-center
          text-purple-700
          ...
          cursor-pointer
        ">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 fill-current mr-2 bi bi-people" fill="currentColor"
         viewBox="0 0 16 16">
          <path
...
export default {
  ...
  methods: {
    createProduct() { this.$router.push("/create-product"); },
    createHall() { this.$router.push("/create-hall");
    },
  }
