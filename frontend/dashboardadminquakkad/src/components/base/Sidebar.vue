<template>
  ...
  >
    ...
    <div class="mb-4 px-4">
      <p class="pl-4 text-sm font-semibold mb-1">ROMS</p>
      <div
        class="
          w-full
          flex
      ...
      >
        ...
        <span class="text-gray-700">Add Rome</span>
      </div>
      <div
        class="
          w-full
      ...
      >
        ...
        <span class="text-gray-700">View Rome</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    // create function to redirect to create product page
    createProduct() {
