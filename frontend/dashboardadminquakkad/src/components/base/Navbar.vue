    ...
    <div class="sticky top-0 z-40">
            <div class="w-full h-20 px-6 bg-gray-100 border-b flex items-center justify-between">
              ...
              <div class="flex items-center relative">
               <Noftication />
                <img :src="pathImg+ user.avatar" class="w-12 h-12 rounded-full shadow-lg" @click="dropDownOpen = !dropDownOpen">
              </div>

            </div>

            <!-- dropdown menu -->
            <div class="absolute bg-gray-100 border border-t-0 shadow-xl text-gray-700 rounded-b-lg w-48  right-0 " :class="dropDownOpen ? '' : 'hidden'">
                
                <router-link to="/account" class="block px-4 py-2 hover:bg-gray-200">Account</router-link>
                <router-link to="/" class="block px-4 py-2 hover:bg-gray-200">Settings</router-link>
